...
public class Collection14Main {
	...
	public static void main(String[] args) throws ParseException {
		...
		Collections.sort(list3,new Asc()); //이름 오름 차순
		System.out.println(list3);
		...
		List<String> arrList = Arrays.asList(arr); //배열을 List<>로 변환 (List<>의 toArray() 의 반대)
		Collections.shuffle(arrList);
		arrList = arrList.subList(0, 3); //index 0 ~ 3 전까지 List<> 생성
...
//Student 를 name으로 오름 차순 정렬해줄수 있는 Comparator<>제공
...
//Student 를 name으로 내림 차순 정렬해줄수 있는 Comparator<>제공
