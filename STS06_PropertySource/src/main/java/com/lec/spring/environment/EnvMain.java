...
public class EnvMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//이제, Environment를 통해 원하는 property에 접근가능
			//굳이 '어떤 PropertySource' 의 '어떤  Property'를 지정 할 필요 없다.
			//'어떤  Property'에 대한 것만 요청하면 propertySources 에 소속된 모든 PropertySource 들을  다 스캔해서 찾아냄.
