...
public class Input04Main {
	...
	public static void main(String[] args) {
		System.out.println("input:String->숫자변환");
		
		Scanner sc = new Scanner(System.in);
		System.out.println("number 3개(int,int,int)입력 받으시오");
		String in1 = sc.next();
		...
		System.out.println("number 3개(double,double,double)입력 받으시오");
		String in2 = sc.next();
		double i4 = Double.parseDouble(in2);
		double i5  = Double.parseDouble(sc.next());
		double i6  = Double.parseDouble(sc.next());
		System.out.println("mul:"+(i4*i5*i6));
		sc.close();
