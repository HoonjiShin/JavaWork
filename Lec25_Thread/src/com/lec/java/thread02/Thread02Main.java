...
public class Thread02Main {
	...
	public static void main(String[] args) {
		...
		// 3. Runnable을 구현하는 클래스의 인스턴스를 생성
		Runnable runnable1 = new MyRunnable("hello,javaframework");
		Runnable runnable2 = new MyRunnable("hello html");
		Runnable runnable3 = new MyRunnable("multi-thread");
		...
		new Thread(new Runnable() {
			...
			int count =0;
			String msg = "fullstack";
			@Override
			public void run() {
				for (int i = 0; i < 100; i++) {
					//Thread.currentThread()- 현재 이코드를 실행중인 Thread객체 return.
