...
public class Polymorphism02Main {
	...
	public static void main(String[] args) {
		...
		driverCar(new Vehicle(),100);
		driverCar(new Car(),200);
		driverCar(new HybridCar(),300);
		
		//instanceof 연산자
		//용법: 변수나 값에 대해서 instanceof class
	...
	public static void driverCar(Vehicle v, int speed) {
		v.setSpeed(speed);
		v.displayInfo();
	}
} // end class