...
public class BoardController {
	...
	/*
	 * @RequestMapping(value = "/updateOk.do", method = RequestMethod.POST) public
	 * String updateOk(BWriteDTO dto, Model model) { model.addAttribute("dto", dto);
	 * new BUpdateCommand().execute(model); return "board/updateOk"; }
	 */
