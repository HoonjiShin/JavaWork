...
--INSERT뿐 아니라 UPDATE/DELETE 에서도 오류발생 가능
UPDATE t_emp3 SET area = 10 WHERE NO =1; --check 값 error

SELECT * FROM t_emp3;
DELETE FROM T_DEPT2 WHERE DCODE = 1000; --참조중인 부모는 삭제 불가
...
ALTER TABLE t_emp4 DROP CONSTRAINT emp4_name_fk; --일단 가존 제약조건 삭제
